...
function EditProfile({ Contact ,setContact}) {
  const { url,ChangeContact } = useContext(contactListContext);
  const {
    handleSubmit,
    register,
    formState: { errors },
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            type="text"
            placeholder="name"
            defaultValue={Contact.name} // Assuming Contact is an object with a name property
            {...register("name", {
